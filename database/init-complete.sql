-- ================================================
-- SCRIPT DE INICIALIZACIÓN COMPLETO - MOTOSEGURA
-- ================================================
-- 
-- INSTRUCCIONES:
...
DROP TABLE IF EXISTS reportes_robo;
DROP TABLE IF EXISTS autopartes;
DROP TABLE IF EXISTS motocicletas;
DROP TABLE IF EXISTS talleres_certificados;
...
SELECT '✓ Base de datos MotoSegura creada exitosamente!' as Resultado;
SELECT '✓ Tablas creadas: 10' as Info;
SELECT 'Ahora puedes iniciar el servidor con: npm start' as 'Siguiente Paso';
